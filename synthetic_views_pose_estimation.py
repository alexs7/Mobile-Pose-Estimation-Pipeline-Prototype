...
point_world_coords = np.empty([0,4])
for good_match in good_matches:
    ...
    pixel_coord = np.floor(np.array([train_x, train_y])).astype(int)
    z = depth_map[pixel_coord[0],pixel_coord[1]] # / 127 ?
